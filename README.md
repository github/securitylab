...
If you would like to add a link into the [CodeQL Resources](#codeql-resources) section of this README, to share a nice video or an awesome tooling, then just add another bullet point in the appropriate section. 
